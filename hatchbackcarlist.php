...
<!--Categories section starts here..-->
    <section class="categories" id="categories">
        ...
        <h1 class="heading"><span>Hatchback</span></h1>
        <div class="box-container">

            <div class="box">
                <img src="hatchbackimage/hatchbackCar-1.png" alt="">
                <h3>2014 Hyundai i20</h3>
                <p>$20.99 / Per Day</p>
                <a href="#" class="btn">Hire Now</a>
            </div>
            <div class="box">
                <img src="hatchbackimage/hatchbackCar-2.png" alt="">
                <h3>2018 Ford Focus</h3>
                <p>$60.99 / Per Day</p>
                <a href="#" class="btn">Hire Now</a>
            </div>
            <div class="box">
                <img src="hatchbackimage/hatchbackCar-3.png" alt="">
                <h3>2017 Volkswagen Polo</h3>
                <p>$34.99 / Per Day</p>
                <a href="#" class="btn">Hire Now</a>
            </div>
...
<section class="footer">
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="#" class="links"> <i class="fas fa-arrow-right">Hatchback Cars</i></a>
