...
<!--Categories section starts here..-->
    <section class="categories" id="categories">
        ...
        <h1 class="heading"><span>SUV</span></h1>
        <div class="box-container">
            ...
            <div class="box">
                <img src="suvimage/suvCar-2.png" alt="">
                <h3>2018 Volkswagen Tiguan</h3>
                <p>$45.90 / Per Day</p>
                <a href="#" class="btn">Hire Now</a>
            </div>
            <div class="box">
                <img src="suvimage/suvCar-3.png" alt="">
                <h3>2018 Jaguar F-PACE</h3>
                <p>$80.99 / Per Day</p>
                <a href="#" class="btn">Hire Now</a>
            </div>
...
<section class="footer">
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="#categories" class="links"> <i class="fas fa-arrow-right">SUV Cars</i></a>
