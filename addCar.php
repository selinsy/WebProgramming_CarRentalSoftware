...
<section class="addcar">
    ...
    <h2></h2>
        ...
        <div id="addcarOpaque">
            <div id="formgroup">
                <div id="leftform">
                    <input type="text" name="carsname" placeholder="Car name" required class="form-control">
...
if(isset($_POST['carsname'], $_POST['category'], $_POST['price'])){
    ...
    $insert=" INSERT INTO cars (carsname, category, price) VALUES 
    ('".$carsname."','".$category."','".$price."')";
