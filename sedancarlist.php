...
<!--Categories section starts here..-->
    <section class="categories" id="categories">
        ...
        <h1 class="heading"><span>Sedan</span></h1>
        <div class="box-container">

            <div class="box">
                <img src="sedanimage/sedanCar-1.png" alt="">
                <h3>2016 BMW 320i</h3>
                <p>$40.99 / Per Day</p>
                <a href="#" class="btn">Hire Now</a>
            </div>
            <div class="box">
                <img src="sedanimage/sedanCar-2.png" alt="">
                <h3>2016 Chevrolet Malibu</h3>
                <p>$30.99 / Per Day</p>
                <a href="#" class="btn">Hire Now</a>
            </div>
            <div class="box">
                <img src="sedanimage/sedanCar-3.png" alt="">
                <h3>2018 BMW 530i</h3>
                <p>$90.99 / Per Day</p>
                <a href="#" class="btn">Hire Now</a>
            </div>
...
<section class="footer">
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="#categories" class="links"> <i class="fas fa-arrow-right">Sedan Cars</i></a>
